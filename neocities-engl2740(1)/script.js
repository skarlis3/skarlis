document.addEventListener("DOMContentLoaded", function() {
    ...
    if (header) {
        ...
        if (localStorage.getItem('fontStyle') === 'sans') {
        ...
        let currentSize = parseFloat(localStorage.getItem('fontSize')) || parseFloat(getComputedStyle(root).getPropertyValue('--reading-size')) || 1.1;
        root.style.setProperty('--reading-size', currentSize + "rem");
    ...
    // Highlights the current chapter in TOC based on the current page URL
